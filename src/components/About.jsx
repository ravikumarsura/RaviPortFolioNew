  ...
  return (
    <section id="about" className="bg-gradient-to-r from-blue-50 to-indigo-100 py-16 px-6 md:px-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
        ...
        {/* Animated Image */}
        <motion.div
          className="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg h-auto rounded-2xl overflow-hidden shadow-lg border-4 border-indigo-500"
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 text-center lg:text-left mb-6">
            About Me
          </h2>
          <p className="text-base md:text-lg text-gray-700 leading-relaxed md:leading-loose text-justify">
          ...
          <div className="space-y-6 mt-6">
            ...
            <motion.div className="bg-white shadow-lg rounded-xl p-6 hover:shadow-2xl transition duration-300" whileHover={{ scale: 1.05 }}>
              ...
              <p className="text-gray-700 mt-2">
                - Proficient in <span className="font-bold">React.js</span> and <span className="font-bold">React Native</span> for modern applications.<br />
                - Strong knowledge of <span className="font-bold">JavaScript, HTML, CSS</span>, and <span className="font-bold">Tailwind CSS</span>.<br />
                - Experience with <span className="font-bold">Redux</span> and <span className="font-bold">Context API</span> for state management.<br />
                - Familiar with <span className="font-bold">Git, Webpack</span>, and <span className="font-bold">Postman</span> for workflow efficiency.
              </p>
            </motion.div>
